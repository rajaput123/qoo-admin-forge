...
const D: Record<string, Dict> = {
  ...
  mod_executive: { en: "Executive Dashboard", hi: "कार्यकारी डैशबोर्ड", sa: "कार्यकारिणीव्यूहः", ta: "செயலக மேலாளர்", te: "ఎగ్జిక్యూటివ్ డాష్‌బోర్డ్", kn: "ಕಾರ್ಯನಿರ್ವಾಹಕ ಡ್ಯಾಶ್‌ಬೋರ್ಡ್" },
