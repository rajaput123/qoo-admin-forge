...
export const PLANS: Plan[] = [
  {
    ...
    price: 0,
    period: "Forever Free",
    description: "Get started with basic temple setup and management",
    modules: ["temple-structure", "communication", "settings"],
    badge: "Free",
    discountPercent: 0,
    gstPercent: 0,
    freeMonths: 0,
  ...
  },
  {
    ...
    price: 3999,
    period: "/month",
    description: "Enable online seva bookings and basic operations",
    modules: [
      "temple-structure", "offerings", "bookings", "prasadam-kitchen", "settings",
    ],
    discountPercent: 5,
    gstPercent: 18,
    freeMonths: 2,
  ...
  },
  {
    ...
    price: 5999,
    period: "/month",
    description: "Full worship management with donations and events",
    modules: [
  ...
  },
  {
    ...
    price: 7999,
    period: "/month",
    description: "Complete temple management with finance and HR",
    modules: [
      "temple-structure", "offerings", "bookings", "donations", "events",
  ...
  },
  {
    ...
    price: 14999,
    period: "/month",
    description: "Enterprise-grade for multi-temple organizations",
    modules: [
      "temple-structure", "offerings", "bookings", "donations", "events",
    ...
    customPriceDescription: "Tailored pricing based on the number of temples, devotee base, and integrations you need.",
    ctaText: "Book a demo",
  },
];
