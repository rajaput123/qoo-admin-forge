        ...
        <div className="space-y-4 max-w-xl">
          <div className="border rounded-lg p-4 bg-muted/20">
            <div className="flex items-center gap-2 mb-3">
              ...
              <Label className="text-sm font-medium">Donation Account / Fund</Label>
            </div>
            <p className="text-xs text-muted-foreground mb-3">
              Select the account where donations for this event will be credited
            </p>
          ...
          <div className="border rounded-lg p-4 bg-muted/20">
            <p className="text-sm text-muted-foreground">
              Donations are enabled for this event. After creation, donation amounts and donor details will be linked automatically from the <span className="font-medium text-foreground">Donation Management</span> module.
            </p>
          </div>
        </div>
      )}
